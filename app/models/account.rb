class Account < ApplicationRecord
  ...
  has_one :profile, class_name: 'Profile', inverse_of: :account, foreign_key: 'account_id', dependent: :destroy
  has_many :posts, class_name: 'Post', inverse_of: :author, foreign_key: 'account_id', dependent: :destroy
